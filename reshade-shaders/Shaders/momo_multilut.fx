...
//
// NOTE(momo): This is stupid and hacky. I don't know why Reshade UI does not 
// support disabling input or just displaying plain text.
//
uniform int fLUT_MultiLUTSelector <
    ui_category = "Pass 1";
    ui_type = "combo";
#if MultiLUTTexture_Source == 0 // GShade/Angelite
    ui_items = "GShade/Angelite\0";
    ...
    ui_items = "Nightingale\0";
#else
    ui_items = "";
#endif
    ui_label = "The MultiLUT file to use.";
    ui_tooltip = "0: GShade [Angelite-Compatible]\n1: Custom\n2: ReShade\n3: Johto\n4: Espresso Glow\n5: Faeshade/Dark Veil/HQ Shade/MoogleShade\n6: ninjafada Gameplay\n7: seri14\n8: Yomi\n9: Neneko\n10:Yaes\n11: Ipsusu\n12: Nightingale\n";
