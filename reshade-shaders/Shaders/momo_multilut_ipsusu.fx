...
#define fLUT_TextureName "momo_multilut_ipsusu.png"
#define fLUT_Selections "Neutral\0IpsusuCool\0IpsusuWarm\0IpsusuPastel\0IpsusuVanilla\0IpsusuAmber\0IpsusuCrystal\0IpsusuMelon\0"
...
texture textMultiLutIpsusu < source = _SOURCE_MULTILUT_FILE; > { Width = _SOURCE_MULTILUT_TILE_SIZE * _SOURCE_MULTILUT_TILE_AMOUNT; Height = _SOURCE_MULTILUT_TILE_SIZE * _SOURCE_MULTILUT_AMOUNT; Format = RGBA8; };
sampler SamplerMultiLUT { Texture = textMultiLutIpsusu; };
...
technique momo_multilut_ipsusu
{
    pass MultiLUT_Apply
    {
